...
class PyVarChart:
    ...
    def _get_marker_dict(self, values: List[Any]) -> Dict[Any, str]:
    ...
    def analyze(self, int_fig_num: int, pd_data: pd.DataFrame) -> Tuple[plt.Figure, plt.Axes]:
        ...
        Example::
            ...
            fig, ax = pvc.analyze(1, my_dataframe)
        ...
        if str_legend and str_legend in pd_data.columns:
            ...
            # Build color dict and marker dict keyed by representative values:
